...
<div class="sheet">
    ...
    <div class="sheet-inner">
        ...
        <div class="body">
            ...
            <div class="ribbon">This certificate confirms licensing registration for the stated licensing year and is issued under the<br />authority of the REPRONIG Secretariat.</div>

            <div class="recipient">{{ $institutionName }}</div>
            <div class="sub-recipient">&nbsp;</div>

            <div class="panel">
                <table class="panel-table">
                    <tr><td class="label">Licence reference</td><td class="value">{{ $licenceNumber }}</td></tr>
                    <tr><td class="label">Licensing year</td><td class="value">{{ $licenceYear }}</td></tr>
                    <tr><td class="label">Valid from</td><td class="value">{{ $validFrom }}</td></tr>
                    <tr><td class="label">Valid to</td><td class="value">{{ $validTo }}</td></tr>
                    <tr><td class="label">Status</td><td class="value">{{ $statusLabel }}</td></tr>
                    <tr><td class="label">Issued on</td><td class="value">{{ $issuedOn }}</td></tr>
                </table>
            </div>
            ...
            <div class="footer">
                This document is issued electronically and should be retained for compliance and audit purposes.
