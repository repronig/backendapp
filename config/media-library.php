...
return [
    ...
    'custom_path_generators' => [
        App\Models\User::class => App\Support\Media\UserAvatarPathGenerator::class,
        App\Models\Association::class => App\Support\Media\UserAvatarPathGenerator::class,
        App\Models\Institution::class => App\Support\Media\UserAvatarPathGenerator::class,
        App\Models\Document::class => App\Support\Media\UserAvatarPathGenerator::class,
    ],
