...
class MemberPdfPresenter
{
    ...
    public function memberMandateCertificateData(MemberApplication $application): array
    {
        ...
        return [
            ...
            'ribbonLine1' => 'This document records your approved membership application, your data-protection consent, and the mandate declarations held by',
            'ribbonLine2' => 'Reproduction Rights Organisation of Nigeria (REPRONIG). Retain this copy for your records.',
